...
<div x-data="{
    ...
    <button class="ml-4 pt-2" id="filament-language-switcher" class="block" x-on:click="toggle">
        <div @class([
                'flex items-center justify-center w-10 h-10 rounded-full bg-gray-200 bg-cover bg-center',
    ...
    <div x-ref="panel" x-float.placement.bottom-end.flip.offset="{ offset: 8 }"
        ...
        @class([
            'filament-dropdown-panel absolute z-10 w-full divide-y divide-gray-100 rounded-lg bg-white shadow-lg ring-1 ring-black/5 transition max-w-[14rem]',
